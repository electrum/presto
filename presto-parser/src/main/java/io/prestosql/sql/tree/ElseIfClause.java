        ...
        extends Node
{
    ...
    public ElseIfClause(Expression expression, List<Statement> statements)
    {
        this(Optional.empty(), expression, statements);
    }

    public ElseIfClause(NodeLocation location, Expression expression, List<Statement> statements)
    {
        this(Optional.of(location), expression, statements);
    }

    private ElseIfClause(Optional<NodeLocation> location, Expression expression, List<Statement> statements)
    {
        super(location);
    ...
    public boolean equals(Object o)
    {
        ...
        ElseIfClause that = (ElseIfClause) o;
